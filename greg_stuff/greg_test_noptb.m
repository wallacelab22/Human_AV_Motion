...
%coherence = 0.5; 
aperture_diameter = 10; %degrees visual angle, given monWidth = 40cm and Viewing Distance from monitor = 53cm
velocity = 5.88; %degrees per second
motion_direction = 180; %0=right, 180=left, 90=up, 270=down
maxdotsperframe = 20; % by trial and error.  Depends on graphics card
%maxdotsperframe = 400; 
%stim_duration = 0.834; %in seconds
stim_duration = 0.2; %in seconds  %GCD: shortened to reduce # frames
n_trials = 5;
iti = 1.2 ;%in seconds
