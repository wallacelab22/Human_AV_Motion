function dotgen(curScreen, monWidth, viewDist, coh, speed, direction, dotSize, maxDotsPerFrame)
% drawDotsTest
%
...
%     Dot stuff    
    ...
    maxDotsPerFrame = 200; % By trial and error and depends on graphics card
