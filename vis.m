...
% All variables that de 2fine stimulus repetitions; num_trials defines total
% number of stair 2 2 1 1 1case trials, stimtrials defines number of stimulus trials
...
givenCoh = 0.5;
block = 'AV';
data_output = [1 0.5 1 1; 1 0.9 1 1; 1 0 1 1; 1 1 1 1; 1 0.3 1 1; 1 0.6 1 1; 1 0.2 1 1; 1 0.05 1 1; 1 0 1 1; 1 0.7 1 1; 1 0.4 1 1; 1 0.1 1 1; 1 0.15 1 1; 1 0.5 1 1; 1 0.3 1 1; 1 0.07 1 1];
noise_reduction_scalar = 1;
    ...
    while true
        ...
        while true
            ...
            if ismember(pressedKeys, right_keypress)
                break;
                done_status = 1;
            elseif ismember(presssedKeys, left_keypress)
                break;
                done_status = 0;
            else
                continue;
        ...
        % Update visual coherence with the givenCoh
