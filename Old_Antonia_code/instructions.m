function instructions(curWindow, cWhite0)
...
Screen('DrawText', curWindow, 'Your task is to indicate the direction of the motion by',200,400,cWhite0);
...
% Instructions 5
Screen('DrawText', curWindow, 'If the motion stimulus is ambiguous, make a decision as best as you can.',200,300,cWhite0);
