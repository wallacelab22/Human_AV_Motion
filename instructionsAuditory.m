function instructionsAuditory(curWindow, cWhite0)

% Instructions 2
Screen('DrawText', curWindow, '...Welcome to this experiment...',400,300,cWhite0);
Screen('DrawText', curWindow, 'This is an AUDITORY motion discrimination task.',200,400,cWhite0);
...
Screen('DrawText', curWindow, 'Your task is to indicate only the direction of the AUDITORY motion by',200,400,cWhite0);
...
% Instructions 5
Screen('DrawText', curWindow, 'If the AUDITORY stimulus is ambiguous, make a decision as best as you can.',200,300,cWhite0);
