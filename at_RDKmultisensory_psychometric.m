...
function MAT=at_RDKmultisensory_psychometric(subject)
%
...
%% RT plots
figure;
%subtitle('RTs of all trials (independent of choice of direction)') 
sgtitle('RTs of all trials (independent of choice of direction)') 
...
sgtitle('RTs corresponding to behavioral choice (trials corresponding to pHit)')
...
sgtitle('RT* computed across RTs from all trials')
subplot(2, 2, 1)
